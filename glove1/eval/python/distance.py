...
def generate():
    ...
    parser.add_argument('--vocab_file', default='output/arm_vocab.txt', type=str)
...
def distance(W, vocab, ivocab, input_term):
    ...
    for x in a:
        print('{0}:({1}, {2})'.format(input_term, ivocab[x], dist[x]))


if __name__ == "__main__":
    N = 10 # number of closest words that will be shown
    W, vocab, ivocab = generate()
    distance1(W, vocab, ivocab)
